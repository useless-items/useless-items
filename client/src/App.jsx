      ...
      <div id="container">
        ...
        <div id="main-section">
          <Routes>
            ...
            <Route path="/cart" element={<Cart token={token} cartItems={cartItems} setCartItems={setCartItems} addToCart={addToCart} cartCounter={cartCounter} setCartCounter={setCartCounter}/>} />
